...
router.get('/products', async (req, res, next) => {
  try {
    const { rows } = await pool.query('SELECT id, name, packing_type, price, unit, price_carton, price_box, price_piece, image, images, description, in_stock, category, company, discount_percent, created_at FROM products WHERE active=true ORDER BY id');
